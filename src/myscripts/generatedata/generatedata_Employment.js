var files=[];
d3.tsv("src/data/data_raw/Industrycode.txt",function(file){
    files.push(file);
    d3.tsv("src/data/data_raw/statecode.txt",function(file){
        files.push(file);
        d3.csv("src/data/data_raw/employment2020.txt",function(file){
            files.push(file);
