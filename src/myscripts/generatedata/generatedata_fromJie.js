...
d3.csv(`src/data/data_with_job_csv/JobDetail_${filename}.csv`, function (error, data){
    let jobo = {}
    let jobd = data.map(d=>{
        let temp = {"nodes":[],
            "jobID":d.JobID,
    ...
    ser.pop();
    d3.csv(`src/data/data_with_job_csv/HostDetail_${filename}.csv`, function (error, data){
